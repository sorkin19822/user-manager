...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'User Manager') ?></title>
...
<body>
    ...
    <script src="<?= BASE_URL ?>assets/js/user-manager.js?v=<?= filemtime(__DIR__ . '/../../public/assets/js/user-manager.js') ?>"></script>
</body>
</html>
